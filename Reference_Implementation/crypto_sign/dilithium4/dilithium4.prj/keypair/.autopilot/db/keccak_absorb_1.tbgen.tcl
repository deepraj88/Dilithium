...
set C_modelArgList {
	...
	{ m int 8 regular {array 1760 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ m_address0 sc_out sc_lv 11 signal 1 } 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "s", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_KeccakF1600_StatePer_fu_301", "Port" : "state"}]},
			{"Name" : "m", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_KeccakF1600_StatePer_fu_301", "Port" : "KeccakF_RoundConstan"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.t_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_KeccakF1600_StatePer_fu_301", "Parent" : "0", "Child" : ["3"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_KeccakF1600_StatePer_fu_301.KeccakF_RoundConstan_U", "Parent" : "2"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5258", "Max" : "5258"}
	, {"Name" : "Interval", "Min" : "5258", "Max" : "5258"}
]}
...
set Spec2ImplPortList { 
	...
	m { ap_memory {  { m_address0 mem_address 1 11 }  { m_ce0 mem_ce 1 1 }  { m_q0 mem_dout 0 8 } } }
}
set moduleName keccak_absorb_1
set isTaskLevelControl 1
set isCombinational 0
