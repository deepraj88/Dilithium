...
set C_modelArgList {
	{ a int 23 regular {array 7680 { 0 3 } 0 1 }  }
	{ a_offset int 3 regular  }
	{ a_offset1 int 3 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "memory", "bitwidth" : 23, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "a_offset1", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ a_offset1 sc_in sc_lv 3 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "a_offset1", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "a_offset1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 13 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 23 } } }
	a_offset { ap_none {  { a_offset in_data 0 3 } } }
	a_offset1 { ap_none {  { a_offset1 in_data 0 3 } } }
