...
set C_modelArgList {
	{ a int 23 regular {array 1536 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ buf_r_address0 sc_out sc_lv 8 signal 4 } 
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 11 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 23 } } }
	a_offset { ap_none {  { a_offset in_data 0 3 } } }
	a_offset1 { ap_none {  { a_offset1 in_data 0 32 } } }
	len { ap_none {  { len in_data 0 10 } } }
	buf_r { ap_memory {  { buf_r_address0 mem_address 1 8 }  { buf_r_ce0 mem_ce 1 1 }  { buf_r_q0 mem_dout 0 8 } } }
}
