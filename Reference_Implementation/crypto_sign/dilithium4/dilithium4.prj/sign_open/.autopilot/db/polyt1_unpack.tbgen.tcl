...
set C_modelName {polyt1_unpack}
set C_modelType { void 0 }
set C_modelArgList {
	{ r_coeffs int 32 regular {array 1536 { 0 0 } 0 1 }  }
	{ r_coeffs_offset int 3 regular  }
	{ a int 8 regular {array 1760 { 1 1 } 1 1 }  }
	{ a_offset int 11 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "r_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "a_offset", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ a_address1 sc_out sc_lv 11 signal 2 } 
	{ a_ce1 sc_out sc_logic 1 signal 2 } 
	{ a_q1 sc_in sc_lv 8 signal 2 } 
	{ a_offset sc_in sc_lv 11 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "r_coeffs_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "r_coeffs", "role": "address0" }} , 
 	...
 	{ "name": "r_coeffs_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "r_coeffs", "role": "address1" }} , 
 	...
 	{ "name": "a_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "a_offset", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	r_coeffs { ap_memory {  { r_coeffs_address0 mem_address 1 11 }  { r_coeffs_ce0 mem_ce 1 1 }  { r_coeffs_we0 mem_we 1 1 }  { r_coeffs_d0 mem_din 1 32 }  { r_coeffs_address1 MemPortADDR2 1 11 }  { r_coeffs_ce1 MemPortCE2 1 1 }  { r_coeffs_we1 MemPortWE2 1 1 }  { r_coeffs_d1 MemPortDIN2 1 32 } } }
	r_coeffs_offset { ap_none {  { r_coeffs_offset in_data 0 3 } } }
	a { ap_memory {  { a_address0 mem_address 1 11 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 8 }  { a_address1 MemPortADDR2 1 11 }  { a_ce1 MemPortCE2 1 1 }  { a_q1 MemPortDOUT2 0 8 } } }
	a_offset { ap_none {  { a_offset in_data 0 11 } } }
}
