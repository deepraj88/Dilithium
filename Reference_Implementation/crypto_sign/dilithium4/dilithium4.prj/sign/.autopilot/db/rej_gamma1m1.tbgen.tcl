...
set C_modelArgList {
	{ a int 24 regular {array 1280 { 0 3 } 0 1 }  }
	{ a_offset int 3 regular  }
	{ a_offset1 int 32 regular  }
	{ len int 10 regular  }
	{ buf_r int 8 regular {array 684 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ buf_r_address1 sc_out sc_lv 10 signal 4 } 
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 11 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 24 } } }
