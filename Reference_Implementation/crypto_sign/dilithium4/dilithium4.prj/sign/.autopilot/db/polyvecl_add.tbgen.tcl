...
set C_modelArgList {
	{ w_vec_coeffs int 32 regular {array 1280 { 2 3 } 1 1 }  }
	{ v_vec_coeffs int 24 regular {array 1280 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ v_vec_coeffs_address0 sc_out sc_lv 11 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "3082", "EstimateLatencyMax" : "3084",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3082", "Max" : "3084"}
	, {"Name" : "Interval", "Min" : "3082", "Max" : "3084"}
]}
...
set Spec2ImplPortList { 
	w_vec_coeffs { ap_memory {  { w_vec_coeffs_address0 mem_address 1 11 }  { w_vec_coeffs_ce0 mem_ce 1 1 }  { w_vec_coeffs_we0 mem_we 1 1 }  { w_vec_coeffs_d0 mem_din 1 32 }  { w_vec_coeffs_q0 mem_dout 0 32 } } }
	v_vec_coeffs { ap_memory {  { v_vec_coeffs_address0 mem_address 1 11 }  { v_vec_coeffs_ce0 mem_ce 1 1 }  { v_vec_coeffs_q0 mem_dout 0 24 } } }
}
set moduleName polyvecl_add
set isTaskLevelControl 1
set isCombinational 0
...
set C_modelType { void 0 }
set C_modelArgList {
	{ w_vec_coeffs int 32 regular {array 1280 { 1 0 } 1 1 }  }
	{ v_vec_coeffs int 24 regular {array 1280 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "w_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1552", "EstimateLatencyMax" : "1555",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1552", "Max" : "1555"}
	, {"Name" : "Interval", "Min" : "1552", "Max" : "1555"}
]}
...
set Spec2ImplPortList { 
	w_vec_coeffs { ap_memory {  { w_vec_coeffs_address0 mem_address 1 11 }  { w_vec_coeffs_ce0 mem_ce 1 1 }  { w_vec_coeffs_q0 mem_dout 0 32 }  { w_vec_coeffs_address1 MemPortADDR2 1 11 }  { w_vec_coeffs_ce1 MemPortCE2 1 1 }  { w_vec_coeffs_we1 MemPortWE2 1 1 }  { w_vec_coeffs_d1 MemPortDIN2 1 32 } } }
	v_vec_coeffs { ap_memory {  { v_vec_coeffs_address0 mem_address 1 11 }  { v_vec_coeffs_ce0 mem_ce 1 1 }  { v_vec_coeffs_q0 mem_dout 0 24 } } }
}
