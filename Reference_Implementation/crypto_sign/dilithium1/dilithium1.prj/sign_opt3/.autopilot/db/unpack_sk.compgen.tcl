...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { s1_vec_coeffs_address0 { O 9 vector } s1_vec_coeffs_ce0 { O 1 bit } s1_vec_coeffs_we0 { O 1 bit } s1_vec_coeffs_d0 { O 32 vector } s1_vec_coeffs_address1 { O 9 vector } s1_vec_coeffs_ce1 { O 1 bit } s1_vec_coeffs_we1 { O 1 bit } s1_vec_coeffs_d1 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { t0_vec_coeffs_address0 { O 10 vector } t0_vec_coeffs_ce0 { O 1 bit } t0_vec_coeffs_we0 { O 1 bit } t0_vec_coeffs_d0 { O 32 vector } } \
} "
} else {
