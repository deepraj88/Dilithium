...
set C_modelName {poly_shiftl}
set C_modelType { void 0 }
set C_modelArgList {
	{ a_coeffs int 32 regular {array 768 { 2 3 } 1 1 }  }
...
set C_modelType { void 0 }
set C_modelArgList {
	{ a_coeffs int 32 regular {array 768 { 1 0 } 1 1 }  }
	{ a_coeffs_offset int 4 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
...
set Spec2ImplPortList { 
	a_coeffs { ap_memory {  { a_coeffs_address0 mem_address 1 10 }  { a_coeffs_ce0 mem_ce 1 1 }  { a_coeffs_q0 mem_dout 0 32 }  { a_coeffs_address1 MemPortADDR2 1 10 }  { a_coeffs_ce1 MemPortCE2 1 1 }  { a_coeffs_we1 MemPortWE2 1 1 }  { a_coeffs_d1 MemPortDIN2 1 32 } } }
	a_coeffs_offset { ap_none {  { a_coeffs_offset in_data 0 4 } } }
}
set moduleName poly_shiftl
set isTaskLevelControl 1
