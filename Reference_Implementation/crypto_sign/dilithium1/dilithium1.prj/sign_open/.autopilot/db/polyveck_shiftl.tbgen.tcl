set moduleName polyveck_shiftl
...
set C_modelName {polyveck_shiftl}
...
set C_modelType { void 0 }
set C_modelArgList {
	{ v_vec_coeffs int 32 regular {array 768 { 1 0 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} ]}
# RTL Port declarations: 
...
set ArgLastReadFirstWriteLatency {
	polyveck_shiftl {
		v_vec_coeffs {Type IO LastRead 4 FirstWrite 3}}}
