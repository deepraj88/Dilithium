...
set C_modelArgList {
	{ z_vec_coeffs int 32 regular {array 512 { 0 3 } 0 1 }  }
	{ h_vec_coeffs int 1 regular {array 768 { 0 3 } 0 1 }  }
	{ c_coeffs int 15 regular {array 256 { 0 3 } 0 1 }  }
	{ sig int 8 regular {array 4787 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ z_vec_coeffs_address0 sc_out sc_lv 9 signal 0 } 
...
set Spec2ImplPortList { 
	z_vec_coeffs { ap_memory {  { z_vec_coeffs_address0 mem_address 1 9 }  { z_vec_coeffs_ce0 mem_ce 1 1 }  { z_vec_coeffs_we0 mem_we 1 1 }  { z_vec_coeffs_d0 mem_din 1 32 } } }
