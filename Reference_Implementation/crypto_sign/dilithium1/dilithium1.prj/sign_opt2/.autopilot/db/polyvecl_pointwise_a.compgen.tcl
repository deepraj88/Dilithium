...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { u_vec_coeffs_address0 { O 11 vector } u_vec_coeffs_ce0 { O 1 bit } u_vec_coeffs_q0 { I 23 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { v_vec_coeffs_address0 { O 9 vector } v_vec_coeffs_ce0 { O 1 bit } v_vec_coeffs_q0 { I 32 vector } } \
} "
} else {
