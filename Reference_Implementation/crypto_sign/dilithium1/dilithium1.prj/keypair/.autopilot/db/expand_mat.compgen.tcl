...
set id 55
set name crypto_sign_keypair_urem_9s_3ns_9_13_seq_1
...
set ID 57
set hasByteEnable 0
set MemName expand_mat_state_s
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename mat_vec_coeffs \
    op interface \
    ports { mat_vec_coeffs_address0 { O 11 vector } mat_vec_coeffs_ce0 { O 1 bit } mat_vec_coeffs_we0 { O 1 bit } mat_vec_coeffs_d0 { O 23 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'mat_vec_coeffs'"
}
}
