...
set C_modelArgList {
	{ r int 8 regular {array 896 { 0 3 } 0 1 }  }
	{ r_offset int 10 regular  }
	{ a_coeffs int 18 regular {array 768 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ a_coeffs_offset sc_in sc_lv 2 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	r { ap_memory {  { r_address0 mem_address 1 10 }  { r_ce0 mem_ce 1 1 }  { r_we0 mem_we 1 1 }  { r_d0 mem_din 1 8 } } }
