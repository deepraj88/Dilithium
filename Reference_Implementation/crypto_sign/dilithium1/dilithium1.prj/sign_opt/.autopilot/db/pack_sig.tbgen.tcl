...
set C_modelArgList {
	...
	{ z_vec_coeffs int 32 regular {array 512 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	...
	z_vec_coeffs { ap_memory {  { z_vec_coeffs_address0 mem_address 1 9 }  { z_vec_coeffs_ce0 mem_ce 1 1 }  { z_vec_coeffs_q0 mem_dout 0 32 } } }
