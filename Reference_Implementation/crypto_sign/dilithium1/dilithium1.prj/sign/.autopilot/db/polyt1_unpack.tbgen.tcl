...
set C_modelArgList {
	{ r_coeffs int 32 regular {array 768 { 0 0 } 0 1 }  }
	{ r_coeffs_offset int 2 regular  }
	{ a int 8 regular {array 896 { 1 1 } 1 1 }  }
	{ a_offset int 10 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "r_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "r_coeffs_offset", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ r_coeffs_offset sc_in sc_lv 2 signal 1 } 
	...
	{ a_offset sc_in sc_lv 10 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "r_coeffs_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "r_coeffs_offset", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	r_coeffs_offset { ap_none {  { r_coeffs_offset in_data 0 2 } } }
	a { ap_memory {  { a_address0 mem_address 1 10 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 8 }  { a_address1 MemPortADDR2 1 10 }  { a_ce1 MemPortCE2 1 1 }  { a_q1 MemPortDOUT2 0 8 } } }
