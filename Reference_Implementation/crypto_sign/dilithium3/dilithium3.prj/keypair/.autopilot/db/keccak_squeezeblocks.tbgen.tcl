...
set C_modelArgList {
	{ h int 8 regular {array 336 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ h_address0 sc_out sc_lv 9 signal 0 } 
	...
	{ s_d0 sc_out sc_lv 64 signal 2 } 
	{ s_q0 sc_in sc_lv 64 signal 2 } 
	{ s_address1 sc_out sc_lv 5 signal 2 } 
	{ s_ce1 sc_out sc_logic 1 signal 2 } 
	{ s_we1 sc_out sc_logic 1 signal 2 } 
	{ s_d1 sc_out sc_lv 64 signal 2 } 
	{ s_q1 sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "h_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "h", "role": "address0" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "s", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_KeccakF1600_StatePer_fu_125", "Port" : "state"}]},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_KeccakF1600_StatePer_fu_125", "Port" : "KeccakF_RoundConstan"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_KeccakF1600_StatePer_fu_125", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_KeccakF1600_StatePer_fu_125.KeccakF_RoundConstan_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	h { ap_memory {  { h_address0 mem_address 1 9 }  { h_ce0 mem_ce 1 1 }  { h_we0 mem_we 1 1 }  { h_d0 mem_din 1 8 } } }
