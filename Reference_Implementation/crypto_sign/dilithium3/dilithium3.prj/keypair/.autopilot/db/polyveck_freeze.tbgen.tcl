set moduleName polyveck_freeze
...
set C_modelName {polyveck_freeze}
set C_modelType { void 0 }
set C_modelArgList {
	{ v_vec_coeffs int 32 regular {array 1280 { 2 2 } 1 1 }  }
}
...
set portList { 
	...
	{ v_vec_coeffs_address1 sc_out sc_lv 11 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v_vec_coeffs_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "v_vec_coeffs", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1291", "EstimateLatencyMax" : "1291",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	polyveck_freeze {
		v_vec_coeffs {Type IO LastRead 4 FirstWrite 4}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1291", "Max" : "1291"}
	, {"Name" : "Interval", "Min" : "1291", "Max" : "1291"}
]}
...
set Spec2ImplPortList { 
	v_vec_coeffs { ap_memory {  { v_vec_coeffs_address0 mem_address 1 11 }  { v_vec_coeffs_ce0 mem_ce 1 1 }  { v_vec_coeffs_we0 mem_we 1 1 }  { v_vec_coeffs_d0 mem_din 1 32 }  { v_vec_coeffs_q0 mem_dout 0 32 }  { v_vec_coeffs_address1 MemPortADDR2 1 11 }  { v_vec_coeffs_ce1 MemPortCE2 1 1 }  { v_vec_coeffs_we1 MemPortWE2 1 1 }  { v_vec_coeffs_d1 MemPortDIN2 1 32 }  { v_vec_coeffs_q1 MemPortDOUT2 0 32 } } }
}
set moduleName polyveck_freeze
set isTaskLevelControl 1
set isCombinational 0
