...
set C_modelArgList {
	{ r int 8 regular {array 1472 { 0 3 } 0 1 }  }
	{ r_offset int 11 regular  }
	{ a_coeffs int 18 regular {array 1280 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ a_coeffs_address0 sc_out sc_lv 11 signal 2 } 
	{ a_coeffs_ce0 sc_out sc_logic 1 signal 2 } 
	{ a_coeffs_q0 sc_in sc_lv 18 signal 2 } 
	{ a_coeffs_address1 sc_out sc_lv 11 signal 2 } 
...
set Spec2ImplPortList { 
	...
	a_coeffs { ap_memory {  { a_coeffs_address0 mem_address 1 11 }  { a_coeffs_ce0 mem_ce 1 1 }  { a_coeffs_q0 mem_dout 0 18 }  { a_coeffs_address1 MemPortADDR2 1 11 }  { a_coeffs_ce1 MemPortCE2 1 1 }  { a_coeffs_q1 MemPortDOUT2 0 18 } } }
