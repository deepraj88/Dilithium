...
set C_modelArgList {
	{ c_coeffs int 32 regular {array 1280 { 2 2 } 1 1 }  }
	{ c_coeffs_offset int 3 regular  }
	{ b_coeffs int 23 regular {array 1280 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ b_coeffs_address1 sc_out sc_lv 11 signal 2 } 
...
set Spec2ImplPortList { 
	c_coeffs { ap_memory {  { c_coeffs_address0 mem_address 1 11 }  { c_coeffs_ce0 mem_ce 1 1 }  { c_coeffs_we0 mem_we 1 1 }  { c_coeffs_d0 mem_din 1 32 }  { c_coeffs_q0 mem_dout 0 32 }  { c_coeffs_address1 MemPortADDR2 1 11 }  { c_coeffs_ce1 MemPortCE2 1 1 }  { c_coeffs_we1 MemPortWE2 1 1 }  { c_coeffs_d1 MemPortDIN2 1 32 }  { c_coeffs_q1 MemPortDOUT2 0 32 } } }
	c_coeffs_offset { ap_none {  { c_coeffs_offset in_data 0 3 } } }
	b_coeffs { ap_memory {  { b_coeffs_address0 mem_address 1 11 }  { b_coeffs_ce0 mem_ce 1 1 }  { b_coeffs_q0 mem_dout 0 23 }  { b_coeffs_address1 MemPortADDR2 1 11 }  { b_coeffs_ce1 MemPortCE2 1 1 }  { b_coeffs_q1 MemPortDOUT2 0 23 } } }
}
set moduleName poly_add
set isTaskLevelControl 1
set isCombinational 0
