...
if {[file isfile crypto_sign_keypair.autotvin.dat]} {
	file delete -force crypto_sign_keypair.autotvin.dat
}

if {[file isfile crypto_sign_keypair.autotvout.dat]} {
	file delete -force crypto_sign_keypair.autotvout.dat
}
