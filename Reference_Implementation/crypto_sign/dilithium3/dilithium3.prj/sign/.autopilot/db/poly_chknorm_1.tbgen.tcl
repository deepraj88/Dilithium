...
set C_modelName {poly_chknorm.1}
set C_modelType { int 1 }
set C_modelArgList {
	{ a_coeffs int 32 regular {array 1280 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "a_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "B", "interface" : "wire", "bitwidth" : 18, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "B", "role": "default" }} , 
...
set Spec2ImplPortList { 
	a_coeffs { ap_memory {  { a_coeffs_address0 mem_address 1 11 }  { a_coeffs_ce0 mem_ce 1 1 }  { a_coeffs_q0 mem_dout 0 32 } } }
	a_coeffs_offset { ap_none {  { a_coeffs_offset in_data 0 32 } } }
	B { ap_none {  { B in_data 0 18 } } }
}
set moduleName poly_chknorm_1
set isTaskLevelControl 1
set isCombinational 0
