...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "5637", "EstimateLatencyMax" : "5637",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5637", "Max" : "5637"}
	, {"Name" : "Interval", "Min" : "5637", "Max" : "5637"}
]}
...
set C_modelType { void 0 }
set C_modelArgList {
	{ w_coeffs int 32 regular {array 1024 { 2 0 } 1 1 }  }
	{ w_coeffs_offset int 3 regular  }
	{ u_vec_coeffs int 23 regular {array 3072 { 1 3 } 1 1 }  }
	{ v_vec_coeffs int 32 regular {array 768 { 1 3 } 1 1 }  }
}
