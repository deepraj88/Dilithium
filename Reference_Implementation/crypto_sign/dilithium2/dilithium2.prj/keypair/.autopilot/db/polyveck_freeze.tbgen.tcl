...
set C_modelArgList {
	{ v_vec_coeffs int 32 regular {array 1024 { 2 2 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	v_vec_coeffs { ap_memory {  { v_vec_coeffs_address0 mem_address 1 10 }  { v_vec_coeffs_ce0 mem_ce 1 1 }  { v_vec_coeffs_we0 mem_we 1 1 }  { v_vec_coeffs_d0 mem_din 1 32 }  { v_vec_coeffs_q0 mem_dout 0 32 }  { v_vec_coeffs_address1 MemPortADDR2 1 10 }  { v_vec_coeffs_ce1 MemPortCE2 1 1 }  { v_vec_coeffs_we1 MemPortWE2 1 1 }  { v_vec_coeffs_d1 MemPortDIN2 1 32 }  { v_vec_coeffs_q1 MemPortDOUT2 0 32 } } }
}
set moduleName polyveck_freeze
set isTaskLevelControl 1
set isCombinational 0
