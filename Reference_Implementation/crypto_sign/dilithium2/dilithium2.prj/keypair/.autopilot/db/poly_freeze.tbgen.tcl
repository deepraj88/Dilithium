...
set C_modelArgList {
	{ a_coeffs int 32 regular {array 1024 { 2 2 } 1 1 }  }
...
set Spec2ImplPortList { 
	a_coeffs { ap_memory {  { a_coeffs_address0 mem_address 1 10 }  { a_coeffs_ce0 mem_ce 1 1 }  { a_coeffs_we0 mem_we 1 1 }  { a_coeffs_d0 mem_din 1 32 }  { a_coeffs_q0 mem_dout 0 32 }  { a_coeffs_address1 MemPortADDR2 1 10 }  { a_coeffs_ce1 MemPortCE2 1 1 }  { a_coeffs_we1 MemPortWE2 1 1 }  { a_coeffs_d1 MemPortDIN2 1 32 }  { a_coeffs_q1 MemPortDOUT2 0 32 } } }
