...
void poly_freeze(poly *a) {
  ...
  poly_freeze_label5:for(i = 0; i < N; ++i)
...
void poly_sub(poly *c, const poly *a, const poly *b) {
  ...
  poly_sub_label18:for(i = 0; i < N; ++i)
...
void poly_shiftl(poly *a) {
  ...
  poly_shiftl_label19:for(i = 0; i < N; ++i)
    a->coeffs[i] <<= D;
                  ...
                  uint16_t nonce)
{
  ...
  while(ctr < N) {
    off = buflen % 3;
    poly_uniform_label20:for(i = 0; i < off; ++i)
...
#error "rej_gamma1m1() assumes GAMMA1 - 1 fits in 19 bits"
  ...
  ctr = pos = 0;
  rej_gamma1m1_label21:while(ctr < len && pos + 5 <= buflen) {
    t0  = buf[pos];
...
#else
  polyeta_pack_label22:for(i = 0; i < N/2; ++i) {
...
#else
  polyeta_unpack_label23:for(i = 0; i < N/2; ++i) {
...
#error "polyt1_pack() assumes D == 14"
  ...
  polyt1_pack_label24:for(i = 0; i < N/8; ++i) {
...
void polyt0_pack(unsigned char *r, const poly *a) {
  ...
  polyt0_pack_label25:for(i = 0; i < N/4; ++i) {
...
void polyt0_unpack(poly *r, const unsigned char *a) {
  ...
  polyt0_unpack_label26:for(i = 0; i < N/4; ++i) {
...
#error "polyz_pack() assumes GAMMA1 <= 2^{19}"
  ...
  polyz_pack_label27:for(i = 0; i < N/2; ++i) {
    /* Map to {0,...,2*GAMMA1 - 2} */
...
void polyw1_pack(unsigned char *r, const poly *a) {
  ...
  polyw1_pack_label28:for(i = 0; i < N/2; ++i)
